        ...
        for file in files:
            ...
            if not await db.has_premium_access(message.from_user.id):
                if not await check_verification(client, message.from_user.id) and VERIFY == True:
                    ...
                    reply_markup = InlineKeyboardMarkup(btn)            await message.reply_text(
...
async def shortlink(bot, message):
    ...
    chat_type = message.chat.type
    if chat_type == enums.ChatType.PRIVATE:
        return await message.reply_text(f"<b>Hey {message.from_user.mention}, This command only works on groups !\n\n<u>Follow These Steps to Connect Shortener:</u>\n\n1. Add Me in Your Group with Full Admin Rights\n\n2. After Adding in Grp, Set your Shortener\n\nSend this command in your group\n\n—> /shortlink ""{your_shortener_website_name} {your_shortener_api}\n\n#Sample:-\n/shortlink https://runurl.in/ref/Abhishek6395 737344e8f092fd933e1cc533f75884744e0394d6\n\nThat's it!!! Enjoy Earning Money 💲\n\n[[[ Trusted Earning Site - https://runurl.in/ref/Abhishek6395]]]\n\nIf you have any Doubts, Feel Free to Ask me - @AV_King1\n\n(Puriyala na intha contact la message pannunga - @AV_King1)</b>")
    elif chat_type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
