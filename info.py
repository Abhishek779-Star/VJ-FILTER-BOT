...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS','-1002046155403')
...
auth_channel = environ.get('AUTH_CHANNEL','-1002006400723')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL','-1002046155403')
