...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6570474744
').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6570474744
').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://abhishek:70ST3n2DRAspPbcF@cluster0.zzzuk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "abhishek:70ST3n2DRAspPbcF")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Techvj')
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://i.ibb.co/fHdb0SB/file-6967.jpg') # payment code picture url.
